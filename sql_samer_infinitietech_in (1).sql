...
--
-- Host: localhost
-- Generation Time: Nov 27, 2025 at 11:19 AM
...
(1, 1, 'testing', 'office', '9876543210', NULL, 'ccsdcsdcsd', NULL, NULL, 1, 'Bhuj', 'NULL', '370030', 1, 0, 'Gujarat', 'india', NULL, NULL, 0),
(2, 27, 'Raj', 'Home', '7984102272', NULL, 'Office No34 Time Square, Uma Nagar, Bhuj', NULL, NULL, 1, 'Bhuj', 'Bhuj', '370616', 1, 0, 'Gujarat', 'India', '23.2328386', '69.6437789', 1),
(3, 1, 'office', 'office', '51616111', '1', 'bfdbhjnvdvnbdvhjb', NULL, NULL, 1, 'Bhuj', 'NULL', '370615', 1, 0, 'Gujarat', 'india', NULL, NULL, 0),
(4, 29, 'testing', 'office', '1234567', NULL, 'test', NULL, NULL, 1, 'Bhuj', 'NULL', '370615', 1, 0, 'gu', 'india', NULL, NULL, 0),
(5, 29, 'cdcd', 'office', '909923575122', NULL, 'vdfvdfv', NULL, NULL, 1, 'Bhuj', 'NULL', '370030', 1, 0, 'Gujarat', 'india', NULL, NULL, 0),
(6, 29, 'nghng', 'office', '90992357514343', NULL, 'nghnghn', NULL, NULL, 1, 'Bhuj', 'NULL', '132456', 1, 0, 'gujarat', 'india', NULL, NULL, 0),
(7, 1, 'hhththhth', 'other', '12345673226', NULL, 'vdvfdv', NULL, NULL, 1, 'Bhuj', 'NULL', '370616', 1, 0, 'Gujarat', 'india', NULL, NULL, 0),
(8, 1, 'john doe', 'other', '90992351657511561', NULL, 'kj jklm', NULL, NULL, 1, 'Bhuj', 'NULL', '132456', 1, 0, 'Gujarat', 'india', NULL, NULL, 0),
(9, 1, 'khamdhrol', 'other', '968541546146', NULL, 'scsdcsd', NULL, NULL, 1, 'Bhuj', 'NULL', '001408', 1, 0, 'Gujarat', 'india', NULL, NULL, 0);
...
(1, 'Nike', 'nike', 'uploads/media/2025/home_hero1.png', 1);
...
(5, 7, 2, 1, 0, 0, '2025-11-18 10:21:03', 1763461263),
(15, 3, 5, 1, 0, 0, '2025-11-21 05:07:38', 1763701658),
(22, 4, 4, 1, 0, 0, '2025-11-22 09:44:42', 1763804682),
(32, 29, 4, 1, 0, 0, '2025-11-26 06:58:58', 1764140338),
(33, 1, 6, 1, 0, 0, '2025-11-26 11:32:40', 1764156760);
...
CREATE TABLE `categories` (
  `id` int(11) NOT NULL,
  `name` varchar(256) NOT NULL,
  `name_ar` varchar(256) DEFAULT NULL COMMENT 'Category name in Arabic',
...
INSERT INTO `categories` (`id`, `name`, `name_ar`, `parent_id`, `slug`, `image`, `banner`, `row_order`, `status`, `is_in_affiliate`, `affiliate_commission`, `clicks`, `seo_page_title`, `seo_meta_keywords`, `seo_meta_description`, `seo_og_image`) VALUES
(1, 'Mobile', NULL, 0, 'mobile', 'uploads/media/2024/mob51.jpg', '', 1, 1, 0, 0.00, 11, NULL, NULL, NULL, NULL),
(2, 'Electronics', NULL, 0, 'electronics', 'uploads/media/2025/pfp.jpeg', NULL, 0, 1, 0, 0.00, 0, '', '', '', ''),
(3, 'test', NULL, 0, 'test', 'uploads/media/2025/pfp.jpeg', NULL, 0, 1, 0, 0.00, 0, '', '', '', '');
...
INSERT INTO `consignments` (`id`, `order_id`, `delivery_boy_id`, `shipping_company_id`, `name`, `status`, `active_status`, `otp`, `delivery_charge`, `created_at`, `updated_at`) VALUES
(1, 19, NULL, NULL, 'gfs', '[[\"received\",\"2025-11-21 04:43:14pm\"],[\"processed\",\"2025-11-21 04:43:14pm\"]]', 'processed', 260774, 100, NULL, NULL),
(2, 18, 4, NULL, 'test', '[[\"received\",\"2025-11-21 04:46:41pm\"],[\"processed\",\"2025-11-21 04:46:41pm\"]]', 'processed', 210054, 200, NULL, NULL),
(3, 23, 4, NULL, 'test', '[[\"received\",\"2025-11-22 03:19:32pm\"],[\"processed\",\"2025-11-22 03:19:32pm\"]]', 'processed', 921372, 100, NULL, NULL);
...
INSERT INTO `consignment_items` (`id`, `consignment_id`, `order_item_id`, `product_variant_id`, `unit_price`, `quantity`, `created_at`, `updated_at`) VALUES
(1, 1, 19, 4, 100, 1, NULL, NULL),
(2, 2, 18, 4, 100, 1, NULL, NULL),
(3, 3, 23, 4, 100, 1, NULL, NULL);
...
INSERT INTO `fund_transfers` (`id`, `delivery_boy_id`, `shipping_company_id`, `opening_balance`, `closing_balance`, `amount`, `status`, `message`, `date_created`) VALUES
(1, 4, NULL, 300, 200, 500, 'pending', 'test', '2025-11-24 09:34:49'),
(2, 0, 29, 0, -202, 202, 'success', 'Admin payout for delivery charges', '2025-11-26 04:36:44');
...
(6, 'shipping_company', 'Shipping company users');
...
(8, 'arabic', 'ar', 'عربي', 1, 0, '2025-11-26 11:22:02');
...
(16, 0, 'pfp', 'pfp.jpeg', 'jpeg', 'image', 'uploads/media/2025/', '6.13', '2025-11-10 09:18:11'),
(17, 0, 'home_hero1', 'home_hero1.png', 'png', 'image', 'uploads/media/2025/', '50.83', '2025-11-10 09:30:03'),
(18, 0, '0000392_15-tr-super-efficient-5-star-split-ac', '0000392_15-tr-super-efficient-5-star-split-ac.jpeg', 'jpeg', 'image', 'uploads/media/2025/', '81.04', '2025-11-10 09:41:58'),
(19, 0, 'download', 'download.jpeg', 'jpeg', 'image', 'uploads/media/2025/', '8.16', '2025-11-21 04:56:54');
...
CREATE TABLE `orders` (
  ...
  `shipping_quote_snapshot` longtext DEFAULT NULL,
  `shipping_company_id` int(11) DEFAULT NULL,
...
INSERT INTO `orders` (`id`, `user_id`, `address_id`, `mobile`, `total`, `delivery_charge`, `is_delivery_charge_returnable`, `wallet_balance`, `promo_code`, `promo_discount`, `discount`, `total_payable`, `final_total`, `payment_method`, `is_cod_collected`, `latitude`, `longitude`, `address`, `delivery_time`, `status`, `delivery_date`, `date_added`, `otp`, `email`, `notes`, `attachments`, `is_pos_order`, `is_shiprocket_order`, `shipping_quote_snapshot`, `shipping_company_id`, `selected_quote_id`) VALUES
(1, 1, 1, '9876543210', 4500, 700, 1, 0, ' ', 0, 0, 5200, 5200, 'COD', 0, '', '', 'ccsdcsdcsd, Bhuj, Gujarat, india, 370030', NULL, '', NULL, '2025-11-11 03:39:53', 0, ' ', '', '', 0, 0, NULL, NULL, NULL),
(2, 27, 2, '7984102272', 5800, 0, 0, 0, ' ', 0, 0, 5800, 5800, 'RazorPay', 0, '23.2328386', '69.6437789', 'Office No34 Time Square, Uma Nagar, Bhuj, Bhuj, Bhuj, Gujarat, India, 370616', NULL, '', NULL, '2025-11-17 11:10:47', 0, ' ', '', '', 0, 0, NULL, NULL, NULL),
(3, 27, 2, '7984102272', 5800, 0, 0, 0, ' ', 0, 0, 5800, 5800, 'bank_transfer', 0, '23.2328386', '69.6437789', 'Office No34 Time Square, Uma Nagar, Bhuj, Bhuj, Bhuj, Gujarat, India, 370616', NULL, '', NULL, '2025-11-17 11:15:14', 0, ' ', '', '', 0, 0, NULL, NULL, NULL),
(4, 1, 3, '51616111', 4500, 0, 0, 0, ' ', 0, 0, 4500, 4500, 'COD', 0, '', '', 'bfdbhjnvdvnbdvhjb, Bhuj, Gujarat, india, 370615', NULL, '', NULL, '2025-11-19 06:20:47', 0, ' ', '', '', 0, 0, NULL, NULL, NULL),
(5, 1, 3, '51616111', 4500, 0, 0, 0, ' ', 0, 0, 4500, 4500, 'COD', 0, '', '', 'bfdbhjnvdvnbdvhjb, Bhuj, Gujarat, india, 370615', NULL, '', NULL, '2025-11-20 03:12:21', 0, ' ', '', '', 0, 0, NULL, NULL, NULL),
(6, 29, 4, '1234567', 4500, 22, 1, 0, ' ', 0, 0, 4522, 4522, 'COD', 0, '', '', 'test, Bhuj, gu, india, 370615', NULL, '', NULL, '2025-11-20 04:50:08', 0, ' ', '', '', 0, 0, '{\\\"id\\\":\\\"2\\\",\\\"shipping_company_id\\\":\\\"26\\\",\\\"zipcode\\\":\\\"370615\\\",\\\"price\\\":\\\"22.00\\\",\\\"eta_text\\\":\\\"3\\\",\\\"cod_available\\\":\\\"1\\\",\\\"additional_charges\\\":\\\"{\\\\\\\\\\\\\\\"gst\\\\\\\\\\\\\\\":121,\\\\\\\\\\\\\\\"xyz\\\\\\\\\\\\\\\":263}\\\",\\\"is_active\\\":\\\"1\\\",\\\"created_at\\\":\\\"2025-11-18 14:32:10\\\",\\\"updated_at\\\":\\\"2025-11-18 14:32:32\\\"}', 26, 2),
(7, 29, 4, '1234567', 4500, 0, 0, 0, ' ', 0, 0, 4500, 4500, 'Paypal', 0, '', '', 'test, Bhuj, gu, india, 370615', NULL, '', NULL, '2025-11-20 05:05:17', 0, ' ', '', '', 0, 0, '{\\\"id\\\":\\\"2\\\",\\\"shipping_company_id\\\":\\\"26\\\",\\\"zipcode\\\":\\\"370615\\\",\\\"price\\\":\\\"22.00\\\",\\\"eta_text\\\":\\\"3\\\",\\\"cod_available\\\":\\\"1\\\",\\\"additional_charges\\\":\\\"{\\\\\\\\\\\\\\\"gst\\\\\\\\\\\\\\\":121,\\\\\\\\\\\\\\\"xyz\\\\\\\\\\\\\\\":263}\\\",\\\"is_active\\\":\\\"1\\\",\\\"created_at\\\":\\\"2025-11-18 14:32:10\\\",\\\"updated_at\\\":\\\"2025-11-18 14:32:32\\\"}', 26, 2),
(8, 29, 4, '1234567', 4500, 50, 1, 0, ' ', 0, 0, 4550, 4550, 'Paypal', 0, '', '', 'test, Bhuj, gu, india, 370615', NULL, '', NULL, '2025-11-20 05:07:02', 0, ' ', '', '', 0, 0, '{\\\"id\\\":\\\"4\\\",\\\"shipping_company_id\\\":\\\"29\\\",\\\"zipcode\\\":\\\"370615\\\",\\\"price\\\":\\\"50.00\\\",\\\"eta_text\\\":\\\"5\\\",\\\"cod_available\\\":\\\"1\\\",\\\"additional_charges\\\":\\\"{\\\\\\\\\\\\\\\"gst\\\\\\\\\\\\\\\":25}\\\",\\\"is_active\\\":\\\"1\\\",\\\"created_at\\\":\\\"2025-11-19 13:15:56\\\",\\\"updated_at\\\":\\\"2025-11-19 13:15:56\\\"}', 29, 4),
(9, 29, 4, '1234567', 4500, 50, 1, 0, ' ', 0, 0, 4550, 4550, 'COD', 0, '', '', 'test, Bhuj, gu, india, 370615', NULL, '', NULL, '2025-11-20 05:22:26', 0, ' ', '', '', 0, 0, '{\\\"id\\\":\\\"4\\\",\\\"shipping_company_id\\\":\\\"29\\\",\\\"zipcode\\\":\\\"370615\\\",\\\"price\\\":\\\"50.00\\\",\\\"eta_text\\\":\\\"5\\\",\\\"cod_available\\\":\\\"1\\\",\\\"additional_charges\\\":\\\"{\\\\\\\\\\\\\\\"gst\\\\\\\\\\\\\\\":25}\\\",\\\"is_active\\\":\\\"1\\\",\\\"created_at\\\":\\\"2025-11-19 13:15:56\\\",\\\"updated_at\\\":\\\"2025-11-19 13:15:56\\\"}', 29, 4),
(10, 1, 3, '51616111', 4500, 0, 0, 0, ' ', 0, 0, 4500, 4500, 'COD', 0, '', '', 'bfdbhjnvdvnbdvhjb, Bhuj, Gujarat, india, 370615', NULL, '', NULL, '2025-11-20 09:42:35', 0, ' ', '', '', 0, 0, '{\\\"id\\\":\\\"2\\\",\\\"shipping_company_id\\\":\\\"26\\\",\\\"zipcode\\\":\\\"370615\\\",\\\"price\\\":\\\"22.00\\\",\\\"eta_text\\\":\\\"3\\\",\\\"cod_available\\\":\\\"1\\\",\\\"additional_charges\\\":\\\"{\\\\\\\\\\\\\\\"gst\\\\\\\\\\\\\\\":121,\\\\\\\\\\\\\\\"xyz\\\\\\\\\\\\\\\":263}\\\",\\\"is_active\\\":\\\"1\\\",\\\"created_at\\\":\\\"2025-11-18 14:32:10\\\",\\\"updated_at\\\":\\\"2025-11-18 14:32:32\\\"}', 26, 2),
(11, 1, 3, '51616111', 4500, 50, 1, 0, ' ', 0, 0, 4550, 4550, 'COD', 0, '', '', 'bfdbhjnvdvnbdvhjb, Bhuj, Gujarat, india, 370615', NULL, '', NULL, '2025-11-20 10:05:22', 0, ' ', '', '', 0, 0, '{\\\"id\\\":\\\"4\\\",\\\"shipping_company_id\\\":\\\"29\\\",\\\"zipcode\\\":\\\"370615\\\",\\\"price\\\":\\\"50.00\\\",\\\"eta_text\\\":\\\"5\\\",\\\"cod_available\\\":\\\"1\\\",\\\"additional_charges\\\":\\\"{\\\\\\\\\\\\\\\"gst\\\\\\\\\\\\\\\":25}\\\",\\\"is_active\\\":\\\"1\\\",\\\"created_at\\\":\\\"2025-11-19 13:15:56\\\",\\\"updated_at\\\":\\\"2025-11-19 13:15:56\\\"}', 29, 4),
(12, 1, 3, '51616111', 4500, 50, 1, 0, ' ', 0, 0, 4550, 4550, 'Paypal', 0, '', '', 'bfdbhjnvdvnbdvhjb, Bhuj, Gujarat, india, 370615', NULL, '', NULL, '2025-11-20 10:11:33', 0, ' ', '', '', 0, 0, '{\\\"id\\\":\\\"4\\\",\\\"shipping_company_id\\\":\\\"29\\\",\\\"zipcode\\\":\\\"370615\\\",\\\"price\\\":\\\"50.00\\\",\\\"eta_text\\\":\\\"5\\\",\\\"cod_available\\\":\\\"1\\\",\\\"additional_charges\\\":\\\"{\\\\\\\\\\\\\\\"gst\\\\\\\\\\\\\\\":25}\\\",\\\"is_active\\\":\\\"1\\\",\\\"created_at\\\":\\\"2025-11-19 13:15:56\\\",\\\"updated_at\\\":\\\"2025-11-19 13:15:56\\\"}', 29, 4),
(13, 1, 3, '51616111', 4500, 50, 1, 0, ' ', 0, 0, 4550, 4550, 'Paypal', 0, '', '', 'bfdbhjnvdvnbdvhjb, Bhuj, Gujarat, india, 370615', NULL, '', NULL, '2025-11-20 10:18:43', 0, ' ', '', '', 0, 0, '{\\\"id\\\":\\\"4\\\",\\\"shipping_company_id\\\":\\\"29\\\",\\\"zipcode\\\":\\\"370615\\\",\\\"price\\\":\\\"50.00\\\",\\\"eta_text\\\":\\\"5\\\",\\\"cod_available\\\":\\\"1\\\",\\\"additional_charges\\\":\\\"{\\\\\\\\\\\\\\\"gst\\\\\\\\\\\\\\\":25}\\\",\\\"is_active\\\":\\\"1\\\",\\\"created_at\\\":\\\"2025-11-19 13:15:56\\\",\\\"updated_at\\\":\\\"2025-11-19 13:15:56\\\"}', 29, 4),
(14, 1, 3, '51616111', 5800, 75, 1, 0, ' ', 0, 0, 5875, 5875, 'COD', 0, '', '', 'bfdbhjnvdvnbdvhjb, Bhuj, Gujarat, india, 370615', NULL, '', NULL, '2025-11-20 11:35:57', 0, ' ', '', '', 0, 0, '{\\\"id\\\":\\\"4\\\",\\\"shipping_company_id\\\":\\\"29\\\",\\\"zipcode\\\":\\\"370615\\\",\\\"price\\\":\\\"50.00\\\",\\\"eta_text\\\":\\\"5\\\",\\\"cod_available\\\":\\\"1\\\",\\\"additional_charges\\\":\\\"{\\\\\\\\\\\\\\\"gst\\\\\\\\\\\\\\\":25}\\\",\\\"is_active\\\":\\\"1\\\",\\\"created_at\\\":\\\"2025-11-19 13:15:56\\\",\\\"updated_at\\\":\\\"2025-11-19 13:15:56\\\"}', 29, 4),
(15, 1, 3, '51616111', 4500, 75, 1, 0, ' ', 0, 0, 4575, 4575, 'COD', 0, '', '', 'bfdbhjnvdvnbdvhjb, Bhuj, Gujarat, india, 370615', NULL, '', NULL, '2025-11-21 03:25:29', 0, ' ', '', '', 0, 0, '{\\\"id\\\":\\\"4\\\",\\\"shipping_company_id\\\":\\\"29\\\",\\\"zipcode\\\":\\\"370615\\\",\\\"price\\\":\\\"50.00\\\",\\\"eta_text\\\":\\\"5\\\",\\\"cod_available\\\":\\\"1\\\",\\\"additional_charges\\\":\\\"{\\\\\\\\\\\\\\\"gst\\\\\\\\\\\\\\\":25}\\\",\\\"is_active\\\":\\\"1\\\",\\\"created_at\\\":\\\"2025-11-19 13:15:56\\\",\\\"updated_at\\\":\\\"2025-11-19 13:15:56\\\"}', 29, 4),
(16, 29, 4, '1234567', 4500, 406, 1, 0, ' ', 0, 0, 4906, 4906, 'COD', 0, '', '', 'test, Bhuj, gu, india, 370615', NULL, '', NULL, '2025-11-21 04:24:33', 0, ' ', '', '', 0, 0, '{\\\"id\\\":\\\"2\\\",\\\"shipping_company_id\\\":\\\"26\\\",\\\"zipcode\\\":\\\"370615\\\",\\\"price\\\":\\\"22.00\\\",\\\"eta_text\\\":\\\"3\\\",\\\"cod_available\\\":\\\"1\\\",\\\"additional_charges\\\":\\\"{\\\\\\\\\\\\\\\"gst\\\\\\\\\\\\\\\":121,\\\\\\\\\\\\\\\"xyz\\\\\\\\\\\\\\\":263}\\\",\\\"is_active\\\":\\\"1\\\",\\\"created_at\\\":\\\"2025-11-18 14:32:10\\\",\\\"updated_at\\\":\\\"2025-11-18 14:32:32\\\"}', 26, 2),
(17, 29, 4, '1234567', 4500, 137867, 1, 0, ' ', 0, 0, 142367, 142367, 'COD', 0, '', '', 'test, Bhuj, gu, india, 370615', NULL, '', NULL, '2025-11-21 04:27:39', 0, ' ', '', '', 0, 0, '{\\\"id\\\":\\\"3\\\",\\\"shipping_company_id\\\":\\\"26\\\",\\\"zipcode\\\":\\\"370615\\\",\\\"price\\\":\\\"135216.00\\\",\\\"eta_text\\\":\\\"3\\\",\\\"cod_available\\\":\\\"1\\\",\\\"additional_charges\\\":\\\"{\\\\\\\\\\\\\\\"cscs\\\\\\\\\\\\\\\":2651}\\\",\\\"is_active\\\":\\\"1\\\",\\\"created_at\\\":\\\"2025-11-19 10:43:22\\\",\\\"updated_at\\\":\\\"2025-11-19 10:43:22\\\"}', 26, 3),
(18, 1, 3, '51616111', 100, 200, 1, 0, ' ', 0, 0, 300, 300, 'COD', 0, '', '', 'bfdbhjnvdvnbdvhjb, Bhuj, Gujarat, india, 370615', NULL, '', NULL, '2025-11-21 05:15:51', 0, ' ', '', '', 0, 0, '{\\\"id\\\":\\\"5\\\",\\\"shipping_company_id\\\":\\\"29\\\",\\\"zipcode\\\":\\\"370615\\\",\\\"price\\\":\\\"100.00\\\",\\\"eta_text\\\":\\\"3 days\\\",\\\"cod_available\\\":\\\"1\\\",\\\"additional_charges\\\":\\\"{\\\\\\\\\\\\\\\"gst\\\\\\\\\\\\\\\":100}\\\",\\\"is_active\\\":\\\"1\\\",\\\"created_at\\\":\\\"2025-11-21 10:29:49\\\",\\\"updated_at\\\":\\\"2025-11-21 10:29:49\\\"}', 29, 5),
(19, 1, 9, '968541546146', 100, 100, 1, 0, ' ', 0, 0, 200, 200, 'COD', 0, '', '', 'scsdcsd, Bhuj, Gujarat, india, 001408', NULL, '', NULL, '2025-11-21 05:37:43', 0, ' ', '', '', 0, 0, NULL, NULL, NULL),
(20, 1, 3, '51616111', 100, 200, 1, 0, ' ', 0, 0, 300, 300, 'COD', 0, '', '', 'bfdbhjnvdvnbdvhjb, Bhuj, Gujarat, india, 370615', NULL, '', NULL, '2025-11-22 04:58:48', 0, ' ', 'Testing', '', 0, 0, NULL, 29, 5),
(21, 1, 3, '51616111', 100, 200, 1, 0, ' ', 0, 0, 300, 300, 'COD', 0, '', '', 'bfdbhjnvdvnbdvhjb, Bhuj, Gujarat, india, 370615', NULL, '', NULL, '2025-11-22 05:12:01', 0, ' ', '', '', 0, 0, NULL, 29, 5),
(22, 1, 3, '51616111', 100, 200, 1, 0, ' ', 0, 0, 300, 300, 'COD', 0, '', '', 'bfdbhjnvdvnbdvhjb, Bhuj, Gujarat, india, 370615', NULL, '', NULL, '2025-11-22 06:37:46', 0, ' ', '', '', 0, 0, NULL, 29, 5),
(23, 1, 9, '968541546146', 100, 100, 1, 0, ' ', 0, 0, 200, 200, 'COD', 0, '', '', 'scsdcsd, Bhuj, Gujarat, india, 001408', NULL, '', NULL, '2025-11-22 09:46:15', 0, ' ', '', '', 0, 0, NULL, NULL, NULL),
(24, 29, 4, '1234567', 100, 200, 1, 0, ' ', 0, 0, 300, 300, 'COD', 0, '', '', 'test, Bhuj, gu, india, 370615', NULL, '', NULL, '2025-11-25 03:41:35', 0, ' ', '', '', 0, 0, NULL, 29, 5),
(25, 29, 4, '1234567', 100, 200, 1, 0, ' ', 0, 0, 300, 300, 'COD', 0, '', '', 'test, Bhuj, gu, india, 370615', NULL, '', NULL, '2025-11-25 04:01:40', 0, ' ', '', '', 0, 0, NULL, 29, 5),
(26, 1, 3, '51616111', 200, 200, 1, 0, ' ', 0, 0, 400, 400, 'COD', 0, '', '', 'bfdbhjnvdvnbdvhjb, Bhuj, Gujarat, india, 370615', NULL, '', NULL, '2025-11-25 05:31:14', 0, ' ', '', '', 0, 0, NULL, 29, 5),
(27, 1, 3, '51616111', 100, 200, 1, 0, ' ', 0, 0, 300, 300, 'COD', 0, '23.2328439', '69.6437733', 'bfdbhjnvdvnbdvhjb, Bhuj, Gujarat, india, 370615', NULL, '', NULL, '2025-11-25 06:06:48', 0, ' ', '', '', 0, 0, NULL, 29, 5),
(28, 1, 3, '51616111', 100, 200, 1, 0, ' ', 0, 0, 300, 300, 'COD', 0, '', '', 'bfdbhjnvdvnbdvhjb, Bhuj, Gujarat, india, 370615', NULL, '', NULL, '2025-11-25 08:16:34', 0, ' ', '', '', 0, 0, NULL, 29, 5),
(29, 1, 3, '51616111', 100, 200, 1, 0, ' ', 0, 0, 300, 300, 'COD', 0, '', '', 'bfdbhjnvdvnbdvhjb, Bhuj, Gujarat, india, 370615', NULL, '', NULL, '2025-11-25 08:40:22', 0, ' ', '', '', 0, 0, NULL, 29, 5);
...
INSERT INTO `order_charges` (`id`, `seller_id`, `product_variant_ids`, `order_id`, `order_item_ids`, `delivery_charge`, `promo_code`, `promo_discount`, `sub_total`, `total`, `otp`, `date_added`) VALUES
(1, 2, '2', 1, '1', 700, '', 0, 4500, 4500, 674515, '2025-11-11 03:39:53'),
(2, 2, '3', 2, '2', 0, NULL, 0, 5800, 5800, 986538, '2025-11-17 11:10:47'),
(3, 2, '3', 3, '3', 0, NULL, 0, 5800, 5800, 424857, '2025-11-17 11:15:14'),
(4, 2, '2', 4, '4', 0, '', 0, 4500, 4500, 664436, '2025-11-19 06:20:47'),
(5, 2, '2', 5, '5', 0, '', 0, 4500, 4500, 589106, '2025-11-20 03:12:21'),
(6, 2, '2', 6, '6', 22, '', 0, 4500, 4500, 251182, '2025-11-20 04:50:08'),
(7, 2, '2', 7, '7', 0, '', 0, 4500, 4500, 181938, '2025-11-20 05:05:17'),
(8, 2, '2', 8, '8', 50, '', 0, 4500, 4500, 582657, '2025-11-20 05:07:03'),
(9, 2, '2', 9, '9', 50, '', 0, 4500, 4500, 272728, '2025-11-20 05:22:26'),
(10, 2, '2', 10, '10', 0, '', 0, 4500, 4500, 561389, '2025-11-20 09:42:35'),
(11, 2, '2', 11, '11', 50, '', 0, 4500, 4500, 467531, '2025-11-20 10:05:22'),
(12, 2, '2', 12, '12', 50, '', 0, 4500, 4500, 380802, '2025-11-20 10:11:33'),
(13, 2, '2', 13, '13', 50, '', 0, 4500, 4500, 831331, '2025-11-20 10:18:43'),
(14, 2, '3', 14, '14', 75, '', 0, 5800, 5800, 716189, '2025-11-20 11:35:57'),
(15, 2, '2', 15, '15', 75, '', 0, 4500, 4500, 184870, '2025-11-21 03:25:29'),
(16, 2, '2', 16, '16', 406, '', 0, 4500, 4500, 144785, '2025-11-21 04:24:33'),
(17, 2, '2', 17, '17', 137867, '', 0, 4500, 4500, 605609, '2025-11-21 04:27:39'),
(18, 3, '4', 18, '18', 200, '', 0, 100, 100, 860724, '2025-11-21 05:15:51'),
(19, 3, '4', 19, '19', 100, '', 0, 100, 100, 417482, '2025-11-21 05:37:43'),
(20, 3, '4', 20, '20', 200, '', 0, 100, 100, 436263, '2025-11-22 04:58:48'),
(21, 3, '4', 21, '21', 200, '', 0, 100, 100, 635330, '2025-11-22 05:12:01'),
(22, 3, '4', 22, '22', 200, '', 0, 100, 100, 447545, '2025-11-22 06:37:46'),
(23, 3, '4', 23, '23', 100, '', 0, 100, 100, 488449, '2025-11-22 09:46:15'),
(24, 3, '4', 24, '24', 200, '', 0, 100, 100, 395315, '2025-11-25 03:41:35'),
(25, 3, '4', 25, '25', 200, '', 0, 100, 100, 321270, '2025-11-25 04:01:40'),
(26, 3, '6,4', 26, '26,27', 200, '', 0, 200, 200, 471178, '2025-11-25 05:31:14'),
(27, 3, '6', 27, '28', 200, '', 0, 100, 100, 306089, '2025-11-25 06:06:48'),
(28, 3, '4', 28, '29', 200, '', 0, 100, 100, 767425, '2025-11-25 08:16:34'),
(29, 3, '6', 29, '30', 200, '', 0, 100, 100, 760977, '2025-11-25 08:40:22');
...
INSERT INTO `order_items` (`id`, `user_id`, `order_id`, `delivery_boy_id`, `shipping_company_id`, `seller_id`, `is_credited`, `otp`, `product_name`, `product_type`, `product_image`, `product_is_cancelable`, `deliveryboy_otp_setting_on`, `return_reason`, `return_item_image`, `product_is_returnable`, `variant_name`, `attachment`, `product_variant_id`, `quantity`, `price`, `discounted_price`, `tax_ids`, `tax_percent`, `tax_amount`, `discount`, `sub_total`, `deliver_by`, `updated_by`, `status`, `admin_commission_amount`, `seller_commission_amount`, `affiliate_id`, `affiliate_token`, `affiliate_commission`, `affiliate_commission_amount`, `is_affiliate_commission_settled`, `active_status`, `hash_link`, `is_sent`, `date_added`, `delivered_quantity`) VALUES
(22, 1, 22, NULL, 29, 3, 0, 447545, 'Air Conditioner', 'simple_product', 'uploads/media/2025/0000392_15-tr-super-efficient-5-star-split-ac.jpeg', 1, 1, NULL, NULL, 1, '', '', 4, 1, 100, NULL, '0', NULL, 0, 0, 100, NULL, 29, '[[\"received\",\"22-11-2025 12:07:46pm\"],[\"processed\",\"22-11-2025 12:09:42pm\"],[\"delivered\",\"24-11-2025 04:42:41pm\"]]', 0, 0, 0, '', 0.00, 0.00, 0, 'delivered', 'NULL', 0, '2025-11-22 06:37:46', 0),
(23, 1, 23, 4, 0, 3, 0, 488449, 'Air Conditioner', 'simple_product', 'uploads/media/2025/0000392_15-tr-super-efficient-5-star-split-ac.jpeg', 1, 1, NULL, NULL, 1, '', '', 4, 1, 100, NULL, '0', NULL, 0, 0, 100, NULL, 3, '[[\"received\",\"22-11-2025 03:16:15pm\"],[\"processed\",\"2025-11-22 15:19:32\"]]', 0, 0, 0, '', 0.00, 0.00, 0, 'processed', 'NULL', 0, '2025-11-22 09:46:15', 1),
(24, 29, 24, NULL, 29, 3, 0, 395315, 'Air Conditioner', 'simple_product', 'uploads/media/2025/0000392_15-tr-super-efficient-5-star-split-ac.jpeg', 1, 1, NULL, NULL, 1, '', '', 4, 1, 100, NULL, '0', NULL, 0, 0, 100, NULL, 0, '[[\"received\",\"25-11-2025 09:11:35am\"]]', 0, 0, 0, '', 0.00, 0.00, 0, 'received', 'NULL', 0, '2025-11-25 03:41:35', 0),
(25, 29, 25, NULL, 29, 3, 0, 321270, 'Air Conditioner', 'simple_product', 'uploads/media/2025/0000392_15-tr-super-efficient-5-star-split-ac.jpeg', 1, 1, NULL, NULL, 1, '', '', 4, 1, 100, NULL, '0', NULL, 0, 0, 100, NULL, 29, '[[\"received\",\"25-11-2025 09:31:40am\"],[\"delivered\",\"25-11-2025 09:32:49am\"]]', 0, 0, 0, '', 0.00, 0.00, 0, 'delivered', 'NULL', 0, '2025-11-25 04:01:40', 0),
(26, 1, 26, NULL, 29, 3, 0, 471178, 'TV 2', 'simple_product', 'uploads/media/2025/download.jpeg', 0, 1, NULL, NULL, 0, '', '', 6, 1, 100, NULL, '0', NULL, 0, 0, 100, NULL, 29, '[[\"received\",\"25-11-2025 11:01:14am\"],[\"delivered\",\"25-11-2025 11:02:50am\"],[\"processed\",\"25-11-2025 11:14:56am\"],[\"shipped\",\"25-11-2025 11:20:03am\"]]', 0, 0, 0, '', 0.00, 0.00, 0, 'shipped', 'NULL', 0, '2025-11-25 05:31:14', 0),
(27, 1, 26, NULL, 29, 3, 0, 471178, 'Air Conditioner', 'simple_product', 'uploads/media/2025/0000392_15-tr-super-efficient-5-star-split-ac.jpeg', 1, 1, NULL, NULL, 1, '', '', 4, 1, 100, NULL, '0', NULL, 0, 0, 100, NULL, 29, '[[\"received\",\"25-11-2025 11:01:14am\"],[\"shipped\",\"25-11-2025 11:15:11am\"],[\"delivered\",\"25-11-2025 11:29:20am\"]]', 0, 0, 0, '', 0.00, 0.00, 0, 'delivered', 'NULL', 0, '2025-11-25 05:31:14', 0),
(28, 1, 27, NULL, 29, 3, 0, 306089, 'TV 2', 'simple_product', 'uploads/media/2025/download.jpeg', 0, 1, NULL, NULL, 0, '', '', 6, 1, 100, NULL, '0', NULL, 0, 0, 100, NULL, 0, '[[\"received\",\"25-11-2025 11:36:48am\"]]', 0, 0, 0, '', 0.00, 0.00, 0, 'received', 'NULL', 0, '2025-11-25 06:06:48', 0),
(29, 1, 28, NULL, 29, 3, 0, 767425, 'Air Conditioner', 'simple_product', 'uploads/media/2025/0000392_15-tr-super-efficient-5-star-split-ac.jpeg', 1, 1, NULL, NULL, 1, '', '', 4, 1, 100, NULL, '0', NULL, 0, 0, 100, NULL, 29, '[[\"received\",\"25-11-2025 01:46:34pm\"],[\"delivered\",\"25-11-2025 01:59:21pm\"]]', 0, 0, 0, '', 0.00, 0.00, 0, 'delivered', 'NULL', 0, '2025-11-25 08:16:34', 0),
(30, 1, 29, NULL, 29, 3, 0, 760977, 'TV 2', 'simple_product', 'uploads/media/2025/download.jpeg', 0, 1, NULL, NULL, 0, '', '', 6, 1, 100, NULL, '0', NULL, 0, 0, 100, NULL, 29, '[[\"received\",\"25-11-2025 02:10:22pm\"],[\"delivered\",\"25-11-2025 02:11:23pm\"]]', 0, 0, 0, '', 0.00, 0.00, 0, 'delivered', 'NULL', 0, '2025-11-25 08:40:22', 0);
...
CREATE TABLE `products` (
  ...
  `name` varchar(512) NOT NULL,
  `name_ar` varchar(512) DEFAULT NULL COMMENT 'Product name in Arabic',
  `short_description` mediumtext DEFAULT NULL,
  `short_description_ar` mediumtext DEFAULT NULL COMMENT 'Short description in Arabic',
  ...
  `description` mediumtext DEFAULT NULL,
  `description_ar` mediumtext DEFAULT NULL COMMENT 'Full description in Arabic',
...
INSERT INTO `products` (`id`, `product_identity`, `category_id`, `brand`, `seller_id`, `tax`, `row_order`, `type`, `stock_type`, `name`, `name_ar`, `short_description`, `short_description_ar`, `slug`, `indicator`, `cod_allowed`, `download_allowed`, `download_type`, `download_link`, `minimum_order_quantity`, `quantity_step_size`, `total_allowed_quantity`, `is_prices_inclusive_tax`, `is_returnable`, `is_cancelable`, `cancelable_till`, `is_attachment_required`, `image`, `other_images`, `video_type`, `video`, `tags`, `warranty_period`, `guarantee_period`, `made_in`, `hsn_code`, `sku`, `stock`, `availability`, `rating`, `no_of_ratings`, `description`, `description_ar`, `extra_description`, `deliverable_type`, `deliverable_zipcodes`, `deliverable_city_type`, `deliverable_cities`, `pickup_location`, `status`, `is_in_affiliate`, `attribute_order`, `low_stock_limit`, `seo_page_title`, `seo_meta_keywords`, `seo_meta_description`, `seo_og_image`, `date_added`) VALUES
(2, NULL, 1, NULL, 2, '', 0, 'simple_product', NULL, 'iphone 11 pro Black', NULL, 'iphone 11 pro Black', NULL, 'iphone-11-pro-black', NULL, 1, 0, '', '', 1, 1, 10, 1, 1, 0, '', 0, 'uploads/media/2024/Iphone_11_pro_Black-2.jpg', '[]', '', '', 'iphone,ios,apple', '', '', NULL, '20081920', NULL, NULL, NULL, 0, 0, '<p>iphone 11 pro Black</p>', NULL, '<p>iphone 11 pro Black</p>', 1, NULL, 0, '', ' ', 1, 1, NULL, 0, NULL, NULL, NULL, NULL, '2024-09-27 12:10:34'),
(3, NULL, 1, NULL, 2, '', 0, 'simple_product', '0', 'Samsung Galaxy A23 5G', NULL, 'Samsung Galaxy A23 5G', NULL, 'samsung-galaxy-a23-5g', NULL, 1, 0, '', '', 1, 1, 10, 1, 1, 1, '', 0, 'uploads/media/2024/Samsung_Galaxy_Z_Flip4_5G-1.jpg', '[]', '', '', 'samsung,android', '', '', NULL, '', 'ASDE', 23, 1, 0, 0, '<p>Samsung Galaxy A23 5G</p>', NULL, '<p>Samsung Galaxy A23 5G</p>', 1, NULL, 0, '', ' ', 1, 1, NULL, 0, NULL, NULL, NULL, NULL, '2024-09-30 09:05:51'),
(4, NULL, 1, NULL, 3, '', 0, 'simple_product', NULL, 'Air Conditioner', NULL, '<p>ac</p>', NULL, 'air-conditioner', NULL, 1, 0, '', '', 1, 1, 10, 1, 1, 1, 'received', 0, 'uploads/media/2025/0000392_15-tr-super-efficient-5-star-split-ac.jpeg', '[]', '', '', 'ac', '', '', 'India', '', NULL, NULL, NULL, 0, 0, '<p>bfgbfgbfgb</p>', NULL, '<p>bgfbfgbfg</p>', 1, NULL, 0, '', ' ', 1, 1, NULL, 0, '', '', '', '', '2025-11-10 09:43:39'),
(5, NULL, 1, NULL, 3, '', 0, 'digital_product', NULL, 'TV', NULL, '<p>tv</p>', NULL, 'tv', NULL, 0, 0, '', '', 1, 1, 1, 0, 0, 0, '', 0, 'uploads/media/2025/download.jpeg', '[]', '', '', 'telivision', '', '', 'India', '', NULL, NULL, NULL, 0, 0, '', NULL, '', 1, NULL, 0, '', ' ', 1, 1, NULL, 0, '', '', '', '', '2025-11-21 04:57:54'),
(6, NULL, 1, NULL, 3, '', 0, 'simple_product', NULL, 'TV 2', 'name in arabic', '<p>test</p>', '<p>sort description in arabic</p>', 'tv-2', NULL, 1, 0, '', '', 1, 1, 10, 0, 0, 0, '', 0, 'uploads/media/2025/download.jpeg', '[]', '', '', 'tv', '', '', NULL, '', NULL, NULL, NULL, 0, 0, '', '<p>description in arabic</p>', '', 1, NULL, 0, '', ' ', 1, 1, NULL, 0, '', '', '', '', '2025-11-25 05:24:45'),
(7, NULL, 1, NULL, 3, '', 0, 'digital_product', NULL, 'name in arabic', 'name in arabic', '<p>test</p>', '<p>test</p>', 'name-in-arabic', NULL, 0, 0, '', '', 1, 1, 1, 0, 0, 0, '', 0, 'uploads/media/2025/pfp.jpeg', '[]', '', '', '', '', '', NULL, '', NULL, NULL, NULL, 0, 0, '<p>testt</p>', '<p>testt</p>', '', 1, NULL, 0, '', ' ', 2, 1, NULL, 0, '', '', '', 'uploads/media/2025/download.jpeg', '2025-11-26 10:15:40');
...
(4, 4, '', '2025-11-10 09:43:39'),
(5, 5, '', '2025-11-21 04:57:54'),
(6, 6, '', '2025-11-25 05:24:45'),
(7, 7, '', '2025-11-26 10:15:40');
...
CREATE TABLE `product_variants` (
  ...
  `vendor_price` double DEFAULT NULL,
...
INSERT INTO `product_variants` (`id`, `product_id`, `attribute_value_ids`, `attribute_set`, `price`, `cost_price`, `vendor_price`, `seller_price`, `special_price`, `sku`, `stock`, `weight`, `height`, `breadth`, `length`, `images`, `availability`, `status`, `date_added`, `final_taxed_price`) VALUES
(2, 2, NULL, NULL, 5000, NULL, NULL, NULL, 4500, NULL, 0, 1, 1, 1, 1, NULL, NULL, 1, '2024-09-27 12:10:34', 0),
(3, 3, NULL, NULL, 60000, NULL, NULL, NULL, 5800, NULL, 26, 1, 1, 1, 1, NULL, NULL, 1, '2024-09-30 09:05:51', 0),
(4, 4, NULL, NULL, 200, NULL, NULL, NULL, 100, NULL, NULL, 10, 100, 23, 226, NULL, NULL, 1, '2025-11-10 09:43:39', 55000),
(5, 5, NULL, NULL, 100, NULL, NULL, NULL, 50, NULL, NULL, 0, 0, 0, 0, NULL, NULL, 1, '2025-11-21 04:57:54', 50),
(6, 6, NULL, NULL, 200, NULL, NULL, NULL, 100, NULL, NULL, 201, 26, 23, 21, NULL, NULL, 1, '2025-11-25 05:24:45', 100),
(7, 7, NULL, NULL, 200, NULL, NULL, NULL, 100, NULL, NULL, 0, 0, 0, 0, NULL, NULL, 1, '2025-11-26 10:15:40', 100);
...
(2, 3, 1, 10.00, '2025-11-26 12:23:55');
...
CREATE TABLE `seller_data` (
  ...
  `seo_meta_description` varchar(1024) DEFAULT NULL,
  `seo_og_image` text DEFAULT NULL,
  `service_radius` decimal(10,2) DEFAULT NULL COMMENT 'Service radius in kilometers. NULL means no limit.',
  `is_location_based` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0 = service everywhere, 1 = location-based service',
  `date_added` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `seller_data` (`id`, `user_id`, `slug`, `category_ids`, `deliverable_zipcode_type`, `deliverable_city_type`, `serviceable_zipcodes`, `serviceable_cities`, `store_name`, `store_description`, `logo`, `store_url`, `no_of_ratings`, `rating`, `bank_name`, `bank_code`, `account_name`, `account_number`, `national_identity_card`, `address_proof`, `authorized_signature`, `pan_number`, `tax_name`, `tax_number`, `permissions`, `commission`, `low_stock_limit`, `status`, `seo_page_title`, `seo_meta_keywords`, `seo_meta_description`, `seo_og_image`, `service_radius`, `is_location_based`, `date_added`) VALUES
(1, 2, 'seller-store', '1', NULL, NULL, NULL, NULL, 'Seller Store', '', '', '', 0, 0.00, '', '', '', '', 'uploads/seller/51Ptg9X9mdL.jpg', 'uploads/seller/il_794xN_2697185910_2oy6.jpg', '', '', 'test', '1234', '{\"require_products_approval\":\"0\",\"customer_privacy\":\"0\",\"view_order_otp\":\"0\",\"assign_delivery_boy\":\"0\"}', 0.00, 15, 1, NULL, NULL, NULL, NULL, NULL, 0, '2022-04-04 05:11:35'),
(2, 3, 'black-pearl', '1', 1, 0, '', '', 'Black pearl', '', 'uploads/seller/full_logo2.png', '', 0, 0.00, '', '', '', '', '', '', 'uploads/seller/pfp2.jpeg', '', 'bbfbfgbf', '625621256', '{\"require_products_approval\":\"1\",\"customer_privacy\":\"1\",\"view_order_otp\":\"1\",\"assign_delivery_boy\":\"1\"}', 1.00, 15, 1, '', '', '', '', NULL, 1, '2025-11-10 09:14:27');
...
(9, 'currency', '₹'),
(11, 'email_settings', '{\"email\":\"infinitie.prashant@gmail.com\",\"password\":\"cvyf tcpl umcb xxdw\",\"smtp_host\":\"smtp.googlemail.com\",\"smtp_port\":\"465\",\"mail_content_type\":\"html\",\"smtp_encryption\":\"ssl\"}'),
...
--
-- Table structure for table `shipping_company_quotes`
--

CREATE TABLE `shipping_company_quotes` (
  `id` int(11) UNSIGNED NOT NULL,
  `shipping_company_id` int(11) UNSIGNED NOT NULL,
  `zipcode` varchar(10) NOT NULL,
  `price` decimal(10,2) NOT NULL DEFAULT 0.00,
  `eta_text` varchar(50) NOT NULL,
...
--
-- Dumping data for table `shipping_company_quotes`
--

INSERT INTO `shipping_company_quotes` (`id`, `shipping_company_id`, `zipcode`, `price`, `eta_text`, `cod_available`, `additional_charges`, `is_active`, `created_at`, `updated_at`) VALUES
(2, 26, '370615', 22.00, '3', 1, '{\\\"gst\\\":121,\\\"xyz\\\":263}', 1, '2025-11-18 14:32:10', '2025-11-18 14:32:32'),
(3, 26, '370615', 135216.00, '3', 1, '{\\\"cscs\\\":2651}', 1, '2025-11-19 10:43:22', '2025-11-19 10:43:22'),
(4, 29, '370615', 50.00, '5', 1, '{\\\"gst\\\":25}', 1, '2025-11-19 13:15:56', '2025-11-19 13:15:56'),
(5, 29, '370615', 100.00, '3 days', 1, '{\\\"gst\\\":100}', 1, '2025-11-21 10:29:49', '2025-11-21 10:29:49');
...
(1, 'New order placed ID #1', 'New order received f', 'place_order', 1, 1, '2025-11-11 03:39:57'),
(2, 'New order placed ID #11', 'New order received f', 'place_order', 11, 0, '2025-11-20 10:05:31'),
(3, 'New order placed ID #12', 'New order received f', 'place_order', 12, 0, '2025-11-20 10:11:37'),
(4, 'New order placed ID #13', 'New order received f', 'place_order', 13, 0, '2025-11-20 10:18:47'),
(5, 'New order placed ID #14', 'New order received f', 'place_order', 14, 0, '2025-11-20 11:36:06'),
(6, 'New order placed ID #15', 'New order received f', 'place_order', 15, 0, '2025-11-21 03:25:38'),
(7, 'New order placed ID #16', 'New order received f', 'place_order', 16, 0, '2025-11-21 04:24:41'),
(8, 'New order placed ID #17', 'New order received f', 'place_order', 17, 0, '2025-11-21 04:27:48'),
(9, 'New order placed ID #18', 'New order received f', 'place_order', 18, 0, '2025-11-21 05:16:00'),
(10, 'New order placed ID #19', 'New order received f', 'place_order', 19, 0, '2025-11-21 05:37:52'),
(11, 'New order placed ID #20', 'New order received f', 'place_order', 20, 0, '2025-11-22 04:58:57'),
(12, 'New order placed ID #21', 'New order received f', 'place_order', 21, 0, '2025-11-22 05:12:09'),
(13, 'New order placed ID #22', 'New order received f', 'place_order', 22, 0, '2025-11-22 06:37:54'),
(14, 'New order placed ID #23', 'New order received f', 'place_order', 23, 1, '2025-11-22 09:46:24'),
(15, 'New order placed ID #24', 'New order received f', 'place_order', 24, 0, '2025-11-25 03:41:44'),
(16, 'New order placed ID #25', 'New order received f', 'place_order', 25, 0, '2025-11-25 04:01:47'),
(17, 'New order placed ID #26', 'New order received f', 'place_order', 26, 0, '2025-11-25 05:31:23'),
(18, 'New order placed ID #27', 'New order received f', 'place_order', 27, 0, '2025-11-25 06:06:57'),
(19, 'New order placed ID #28', 'New order received f', 'place_order', 28, 0, '2025-11-25 08:16:48'),
(20, 'New order placed ID #29', 'New order received f', 'place_order', 29, 0, '2025-11-25 08:40:31');
...
(14, 'transaction', 29, '24', NULL, 'cod', '', NULL, 300, 'received', NULL, NULL, '', '2025-11-25 03:41:48', '2025-11-25 03:41:48', 0),
(15, 'transaction', 29, '25', NULL, 'cod', '', NULL, 300, 'received', NULL, NULL, '', '2025-11-25 04:01:52', '2025-11-25 04:01:52', 0),
(16, 'transaction', 29, '25', 25, 'shipping_company_cash_collection', '', NULL, 100, '1', NULL, NULL, 'test', '2025-11-25 05:05:00', '2025-11-25 04:02:49', 0),
(17, 'transaction', 1, '26', NULL, 'cod', '', NULL, 400, 'received', NULL, NULL, '', '2025-11-25 05:31:28', '2025-11-25 05:31:28', 0),
(18, 'transaction', 29, '26', 26, 'shipping_company_cash_collection', '', NULL, 100, '1', NULL, NULL, 'testttttttttt', '2025-11-25 06:01:00', '2025-11-25 05:32:50', 0),
(19, 'transaction', 29, '26', 27, 'shipping_company_cash_collection', '', NULL, 100, '1', NULL, NULL, 'hyhyhhyhyhyhyhy', '2025-11-25 08:03:00', '2025-11-25 05:59:20', 0),
(20, 'transaction', 1, '27', NULL, 'cod', '', NULL, 300, 'received', NULL, NULL, '', '2025-11-25 06:07:00', '2025-11-25 06:07:00', 0),
(21, 'transaction', 1, '28', NULL, 'cod', '', NULL, 300, 'received', NULL, NULL, '', '2025-11-25 08:16:52', '2025-11-25 08:16:52', 0),
(22, 'transaction', 29, '28', 29, 'shipping_company_cash_collection', '', NULL, 100, '1', NULL, NULL, 'collecting cod money from shipping company to admin balance/', '2025-11-25 08:38:00', '2025-11-25 08:29:21', 0),
(23, 'transaction', 1, '28', NULL, 'credit', 'CASH_COLLECTION_1764059794', NULL, 100, '1', NULL, NULL, 'Cash collected from shipping company: Black Pearl', '2025-11-25 08:38:00', '2025-11-25 08:36:34', 0),
(24, 'transaction', 1, '29', NULL, 'cod', '', NULL, 300, 'received', NULL, NULL, '', '2025-11-25 08:40:35', '2025-11-25 08:40:35', 0),
(25, 'transaction', 29, '29', 30, 'shipping_company_cash_collection', '', NULL, 100, '1', NULL, NULL, 'pppppppppppppppppppppp', '2025-11-25 08:44:00', '2025-11-25 08:41:23', 0),
(26, 'transaction', 1, '29', NULL, 'credit', 'CASH_COLLECTION_1764060155', NULL, 100, '1', NULL, NULL, 'Cash collected from shipping company: Black Pearl', '2025-11-25 08:44:00', '2025-11-25 08:42:35', 0),
(27, 'transaction', 1, '', NULL, 'debit', 'ADMIN_PAYOUT_1764131804', NULL, 202, '1', NULL, NULL, 'Payout to shipping company: Black Pearl', '2025-11-26 04:35:00', '2025-11-26 04:36:44', 0),
(28, 'transaction', 29, '', NULL, 'credit', 'COMPANY_PAYOUT_1764131804', NULL, 202, '1', NULL, NULL, 'Admin payout for delivery charges', '2025-11-26 04:35:00', '2025-11-26 04:36:44', 0);
...
CREATE TABLE `users` (
  ...
  `is_shipping_company` tinyint(1) NOT NULL DEFAULT 0,
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `email`, `mobile`, `image`, `balance`, `activation_selector`, `activation_code`, `forgotten_password_selector`, `forgotten_password_code`, `forgotten_password_time`, `remember_selector`, `remember_code`, `created_on`, `last_login`, `last_online`, `active`, `company`, `address`, `bonus_type`, `bonus`, `cash_received`, `dob`, `country_code`, `city`, `area`, `street`, `pincode`, `serviceable_zipcodes`, `serviceable_cities`, `apikey`, `referral_code`, `friends_code`, `fcm_id`, `platform_type`, `latitude`, `longitude`, `type`, `is_shipping_company`, `driving_license`, `status`, `is_affiliate_user`, `web_fcm`, `created_at`, `kyc_documents`) VALUES
(1, '41.176.193.214', 'Admin', '$2y$12$WTwd2ZJKB1eIq9HloMkugeQdawRRpOPbMZ8zlj4iv37nrf0.6vTnK', 'admin@gmail.com', '12345678', NULL, 21610473636.449993, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1268889823, 1764161228, 1764163551, 1, 'ADMIN', NULL, 'percentage_per_order', NULL, 0.00, NULL, 91, '57', '157', NULL, NULL, NULL, NULL, NULL, 'vXaEvNuR', NULL, 'fFQa3MftQ6uliFS6T1IdGk:APA91bGNY-dntY4Yu0zTtjS9hB1ncLHnVmyDnnF4QCvRx3BOT57TfKAIIg036aBQ2tNt3SKFyLVGamBviZu0TjDluRdojAVJMdH40BwL3Hrpr6YNkYwQGYzwmKfpf42Ktp0AyITmT7R5', NULL, NULL, NULL, 'phone', 0, 'NULL', 0, 0, '', '2020-06-30 10:20:08', NULL),
(2, '::1', 'Seller', '$2y$10$JkeDBNNmpfx7aD9UET/pZe6mfqlN2daHNJ5m.jcfaUkQvpZmYYl3e', 'seller@gmail.com', '222222222', NULL, 0, '9bab4eda6f47dce6ddcd', '$2y$10$53cUBe9kLAVrpyS.A8Mz/OP6eeXc/u5uQUdbV6TP0MU/aS03Yv8c.', NULL, NULL, NULL, NULL, NULL, 1649049092, NULL, NULL, 1, NULL, '237 time square', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', 'phone', 0, 'NULL', 0, 0, '', '2022-04-04 05:11:32', NULL),
(3, '::1', 'jack sparrow', '$2y$10$4jAg2u5kXQZB./trPYVYVeOBL3/VtYyf9uJ6I4sFhEE774y/8Mqiq', 'jack@gmail.com', '9978398769', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1762766067, 1764052331, 1763702044, 1, NULL, 'cdscscscscs', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '54.5260', '105.2551', 'phone', 0, 'NULL', 0, 0, '', '2025-11-10 09:14:27', NULL),
(4, '::1', 'john doe', '$2y$10$.d8YsQKcvGlz/A0WqaW.Xuu4oMShPd.4uX3PDso/WtZAb2wM5Jr.W', 'john@gmail.com', '1234567', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1762766140, 1763976935, 1763964326, 1, NULL, 'dvvdvdfvdf', 'percentage_per_order_item', 12, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, '1', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 0, 'uploads/delivery_boy/Screenshot_from_2025-11-08_16-41-04.png,uploads/delivery_boy/Screenshot_from_2025-11-05_09-14-24.png', 1, 0, '', '2025-11-10 09:15:40', NULL),
(5, '::1', 'test', '$2y$10$QO0p3dG4768pRUMtaIpXveWIK7Apo6hG6JsZzBuhfY1DOTcxP7iQu', 'test@gmail.com', '5555555555', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1762928265, NULL, NULL, 1, NULL, 'Ut temporibus quam m', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 1, 0, '', '2025-11-12 06:17:45', 'uploads/shipping_company/Screenshot_from_2025-11-11_09-28-461.png,uploads/shipping_company/Detailed_Shipping_Checkout_Flow_(1)1.png'),
(6, '::1', 'test2', '$2y$10$rJysxSaJX4UkQmp5H/jgK.BRt.Qkd82.OdIlyxadTzfG3KRnsjw/e', 'testcdc@gmail.com', '123456778', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1762934624, NULL, NULL, 1, NULL, 'Ut temporibus quam m', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 0, 0, '', '2025-11-12 08:03:44', 'uploads/shipping_company/Screenshot_from_2025-11-11_09-28-462.png'),
(7, '::1', 'test2', '$2y$10$xFKckMKJt6sL3XDc3HPSFuV4ogwK57gDtuDE4sGZQO7v5Av2Gji4i', 'testcdcsd@gmail.com', '9876543210', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1762936141, 1763461226, 1763461371, 1, NULL, 'Ut temporibus quam m', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 1, 0, '', '2025-11-12 08:29:01', 'uploads/shipping_company/home_hero11.png'),
(8, '::1', 'aaaa', '$2y$10$.kSfQmSyWNgyc0GSwwvbu.7jCIJ5PScj65WbpCzp4zkfXO8RZid3C', 'testcvcdv@gmail.com', '2169519685156', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1762936254, NULL, NULL, 1, NULL, 'Address', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 1, 0, '', '2025-11-12 08:30:54', 'uploads/shipping_company/Screenshot_from_2025-11-11_09-28-464.png'),
(9, '::1', 'cscs', '$2y$10$bz30yQxODOD6m2dNeJRhT.P/UTpgUcdBEJs06dS/sIT4OBtYiWptW', 'testcdcsdc@gmail.com', '15665', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1762936300, NULL, NULL, 1, NULL, 'Fugiat labore optio', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 1, 0, '', '2025-11-12 08:31:40', 'uploads/shipping_company/Screenshot_from_2025-11-11_09-28-465.png'),
(10, '::1', '56516', '$2y$10$E4G8XhtRYmiJr/iENXyQqOcrGRbZ5ymOyivPCwy7ap.hCzIbJnk4e', 'xidijeg328@delaeb.com', '156561', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1762936366, NULL, NULL, 1, NULL, 'Fugiat labore optio', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 1, 0, '', '2025-11-12 08:32:46', 'uploads/shipping_company/home_hero12.png'),
(11, '::1', 'ccvdfvdfv', '$2y$10$.UeWS2hSekhHU8XhEH5hROOi5RpOXdwoSy0fmismn479cdsD2wEei', 'testfvdvd@gmail.com', '12345673226', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1762936840, NULL, NULL, 1, NULL, 'Fugiat labore optio', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 1, 0, '', '2025-11-12 08:40:40', 'uploads/shipping_company/Screenshot_from_2025-11-11_09-28-466.png'),
(12, '::1', 'test2', '$2y$10$51T640FGMEUVcbWJzzUxveMYkG.KMPBphZqpQTsxP/Ap/JZnkLvEm', 'john123456@gmail.com', '4156146556', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1763007620, NULL, NULL, 1, NULL, 'Ut temporibus quam m', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 1, 0, '', '2025-11-13 04:20:20', 'uploads/shipping_company/home_hero16.png'),
(13, '::1', 'company1', '$2y$10$yrPDCxIVjqxIP5xYsjgEW.Cky0oBBakY4iI0nDbo5mwrLXuofnyJq', 'xidijeg316528@delaeb.com', '1561546156', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1763008516, NULL, NULL, 1, NULL, 'Address', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 1, 0, '', '2025-11-13 04:35:16', 'uploads/shipping_company/home_hero18.png'),
(14, '::1', 'test2', '$2y$10$TXjKDFAeJ/8fyzhwyC5.OOL9RRxn4IOjrGLCOQIn3UgAt.ot/2bTy', 'xidijeg35528@delaeb.com', '165165165', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1763009209, NULL, NULL, 1, NULL, 'Address', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, '2,3', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 1, 0, '', '2025-11-13 04:46:49', 'uploads/shipping_company/home_hero19.png'),
(15, '::1', 'ccvdfvdfv', '$2y$10$XayrTxoUMt1pVxkoX1Nrv.hWmGDV9KwV2aPJiUDojOlEJr/azF/HO', 'john12345dcsdc6@gmail.com', '41614596156', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1763009383, NULL, NULL, 1, NULL, 'Address', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 0, 0, '', '2025-11-13 04:49:43', 'uploads/shipping_company/home_hero110.png'),
(16, '::1', 'cdscsdcs', '$2y$10$Ah9i03qeJD4iYGrnjxbsuOK6GSbEWlGDnubq.QZyf0MrnW19wgvqi', 'tesdcdcdt@gmail.com', '416516156', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1763009499, NULL, NULL, 1, NULL, 'Address', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 1, 0, '', '2025-11-13 04:51:39', 'uploads/shipping_company/home_hero111.png'),
(17, '::1', 'csdcds', '$2y$10$Ab871w9/ON.KkS5Ix.3dIORVoFx8QtDVfob3iJLvpu4kamwOPaJSS', 'johnddd@gmail.com', '123456732261561', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1763009599, NULL, NULL, 1, NULL, 'Address', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 1, 0, '', '2025-11-13 04:53:19', 'uploads/shipping_company/home_hero112.png'),
(18, '::1', 'cvvdvdfv', '$2y$10$OpIHhQ8ObkC8kFnNkrvAC.iBuEdabeDX4OR72ihZCBMuUzKjuepOS', 'tescdcdct@gmail.com', '1565615616', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1763009897, NULL, NULL, 1, NULL, 'Address', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, '2', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 1, 0, '', '2025-11-13 04:58:17', 'uploads/shipping_company/home_hero116.png'),
(19, '::1', 'test2', '$2y$10$rc7qQPEdkpVEHL0./TAGJeS3Pal9gopcIaDKVyXH0282fpRhwtBh6', 'john1234555556@gmail.com', '1654161', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1763010005, NULL, NULL, 1, NULL, 'Address', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, '2,3', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 1, 0, '', '2025-11-13 05:00:05', 'uploads/shipping_company/home_hero117.png'),
(20, '::1', 's-company1', '$2y$10$a0UtZ44BqKInBbqQsHsIqexsn3YE9ERk/ZGOG.jqYc0MruqaaC/QC', 's@gmail.cxom', '9898989898', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1763015782, NULL, NULL, 1, NULL, 'ncdnjdcsjk', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, '3,2', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 1, 0, '', '2025-11-13 06:36:22', 'uploads/shipping_company/home_hero118.png'),
(23, '::1', 'jack', '$2y$10$2qCNEgWVxexY2gFbC40/7OOZBDdTAoeWvmLKUGvBCUM5AejF2kgIe', 'infinitie.rahul@gmail.com', '4646464646', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1763027979, NULL, NULL, 1, NULL, 'Address', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, '2', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 1, 0, '', '2025-11-13 09:59:39', 'uploads/shipping_company/Screenshot_from_2025-11-11_09-28-468.png'),
(24, '::1', 'test company', '$2y$10$kII5fycFhEHcKnP2O0NbAO75Ti/rTP2GHf5eBu1eXAXPecZ24n3um', 'prashantkuwat7@gmail.com', '9595959595', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1763355549, NULL, NULL, 1, NULL, 'Address', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 0, 0, '', '2025-11-17 04:59:09', 'uploads/shipping_company/Screenshot_from_2025-11-17_08-37-30.png'),
(25, '::1', 'tony stark', '$2y$10$9/YY7oWfyKxuOH.mHfLFUOMlW0w.2Y.mcFMMwfKc6I6A.lFhqvjHK', 'tony@gmail.com', '1212121212', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1763357633, NULL, NULL, 1, NULL, 'Address', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 0, 0, '', '2025-11-17 05:33:53', 'uploads/shipping_company/Screenshot_from_2025-11-11_09-28-469.png'),
(27, '162.158.193.251', 'Raj', '$2y$10$sTV/mAfGf6fNUQsTfpN3c.L.DHoe3yziiNSci0MY4iYM49T14pnIS', 'infinitie.raj@gmail.com', '7984102272', NULL, 100, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1763377759, NULL, NULL, 1, NULL, NULL, 'percentage_per_order', NULL, 0.00, NULL, 91, NULL, NULL, NULL, NULL, NULL, NULL, 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE3NjMzNzc3NTksImlzcyI6ImVzaG9wIiwiZXhwIjoxNzk0OTEzNzU5LCJ1c2VyX2lkIjoiMjcifQ.-FSVRr_VC1OU_pmPHEX7JUaPMPuvgRHq5prKcQ3IBf8', 'HFiaMv1M', '', NULL, NULL, NULL, NULL, 'phone', 0, 'NULL', 0, 0, '', '2025-11-17 11:09:19', NULL),
(28, '172.71.198.81', 'test2dfvfdvfdvdf', '$2y$10$XGz3lPY163rXqbY75MV7ZeUPU8R/2FgtAqqUVznhJw0bYBMyuK/xi', 'xidijeg3282156@delaeb.com', '1234567825985965', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1763523051, NULL, NULL, 1, NULL, 'Address', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, '2', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 1, 0, '', '2025-11-19 03:30:51', 'uploads/shipping_company/Screenshot_from_2025-11-11_09-28-4612.png'),
(29, '162.158.227.225', 'Black Pearl', '$2y$10$FNjpckZaMROqeXw5ZyG7VekEbt8qGPHynEZVDWfNUA0i4ITt7gpTy', 'infintie.jacksparrow@gmail.com', '9978398768', 'uploads/user_image/pfp.jpeg', 202, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1763524095, 1764140337, 1764140451, 1, NULL, 'Address updated', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, '2', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 1, 0, '', '2025-11-19 03:48:15', 'uploads/shipping_company/Screenshot_from_2025-11-17_08-37-308.png'),
(30, '172.69.86.182', 'dvdfv', '$2y$10$.Nn1p1PUuYXCm3deiH7MleVV/T5x8E8cw1DJohDDmNzqQTZ4a4PWe', 'jackbfgbfg@gmail.com', '12345673226256', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1763528061, NULL, NULL, 1, NULL, 'Address', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 1, 0, '', '2025-11-19 04:54:21', 'uploads/shipping_company/Screenshot_from_2025-11-11_09-28-4614.png'),
(31, '172.69.86.182', 'test2', '$2y$10$WMInurfvdZiCTJUdf.KoJ.9auwbCco8bp3t7O6rJgjr3u8.Ygkqw.', 'jacksdcdscs@gmail.com', '9876543210516', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1763528118, NULL, NULL, 1, NULL, 'Address', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 1, 0, '', '2025-11-19 04:55:18', 'uploads/shipping_company/Screenshot_from_2025-11-17_08-37-309.png'),
(32, '172.69.86.183', 'test2', '$2y$10$E..qReZIjBTaOIEZ89CkW.C1jCS11v4HOFJfLX10uNsXwNVe2yD6e', 'ojvfdjkmnvfjkvd@gmail.com', '9099235751651655', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1763528295, NULL, NULL, 1, NULL, 'Address', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 1, 0, '', '2025-11-19 04:58:15', 'uploads/shipping_company/Screenshot_from_2025-11-11_09-28-4616.png'),
(33, '172.69.95.179', 'test2', '$2y$10$Jhgo4rpu0tmTBsdgaJ0WjemkbyZSJvSueaUeQERBhKWa0CeEbeihq', 'xidiccccccjeg328@delaeb.com', '90992357511561', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1763528957, NULL, NULL, 1, NULL, 'Address', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, '2', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 1, 0, '', '2025-11-19 05:09:17', 'uploads/shipping_company/Screenshot_from_2025-11-11_09-28-4617.png'),
(34, '172.69.95.180', 'vdfvfdvd', '$2y$10$1czg7xE6.r8wn7XYmTU7a.YXd4qX1DLii7R3OF/7vALJA7xRM9PBm', 'jacksdcdcdccddscs@gmail.com', '9099235751165611', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1763529145, NULL, NULL, 1, NULL, 'Address', 'percentage_per_order', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, '3,2', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', 1, 'NULL', 1, 0, '', '2025-11-19 05:12:25', 'uploads/shipping_company/Screenshot_from_2025-11-11_09-28-4618.png');
...
(3, 'jack@gmail.com', 'google', NULL, '2025-11-10 14:44:27', NULL),
(4, NULL, 'google', '9978398769', '2025-11-10 14:44:27', NULL),
(5, 'john@gmail.com', 'google', NULL, '2025-11-10 14:45:40', NULL),
(6, NULL, 'google', '1234567', '2025-11-10 14:45:40', NULL),
(7, 'test@gmail.com', 'google', NULL, '2025-11-12 11:47:45', NULL),
(8, NULL, 'google', '5555555555', '2025-11-12 11:47:45', NULL),
(9, 'testcdc@gmail.com', 'google', NULL, '2025-11-12 13:33:44', NULL),
(10, NULL, 'google', '123456778', '2025-11-12 13:33:44', NULL),
(11, 'testcdcsd@gmail.com', 'google', NULL, '2025-11-12 13:59:01', NULL),
(12, NULL, 'google', '9876543210', '2025-11-12 13:59:01', NULL),
(13, 'testcvcdv@gmail.com', 'google', NULL, '2025-11-12 14:00:54', NULL),
(14, NULL, 'google', '2169519685156', '2025-11-12 14:00:54', NULL),
(15, 'testcdcsdc@gmail.com', 'google', NULL, '2025-11-12 14:01:40', NULL),
(16, NULL, 'google', '15665', '2025-11-12 14:01:40', NULL),
(17, 'xidijeg328@delaeb.com', 'google', NULL, '2025-11-12 14:02:46', NULL),
(18, NULL, 'google', '156561', '2025-11-12 14:02:46', NULL),
(19, 'testfvdvd@gmail.com', 'google', NULL, '2025-11-12 14:10:40', NULL),
(20, NULL, 'google', '12345673226', '2025-11-12 14:10:40', NULL),
(21, 'john123456@gmail.com', 'google', NULL, '2025-11-13 09:50:20', NULL),
(22, NULL, 'google', '4156146556', '2025-11-13 09:50:20', NULL),
(23, 'xidijeg316528@delaeb.com', 'google', NULL, '2025-11-13 10:05:15', NULL),
(24, NULL, 'google', '1561546156', '2025-11-13 10:05:15', NULL),
(25, 'xidijeg35528@delaeb.com', 'google', NULL, '2025-11-13 10:16:49', NULL),
(26, NULL, 'google', '165165165', '2025-11-13 10:16:49', NULL),
(27, 'john12345dcsdc6@gmail.com', 'google', NULL, '2025-11-13 10:19:43', NULL),
(28, NULL, 'google', '41614596156', '2025-11-13 10:19:43', NULL),
(29, 'tesdcdcdt@gmail.com', 'google', NULL, '2025-11-13 10:21:38', NULL),
(30, NULL, 'google', '416516156', '2025-11-13 10:21:38', NULL),
(31, 'johnddd@gmail.com', 'google', NULL, '2025-11-13 10:23:19', NULL),
(32, NULL, 'google', '123456732261561', '2025-11-13 10:23:19', NULL),
(33, 'tescdcdct@gmail.com', 'google', NULL, '2025-11-13 10:28:17', NULL),
(34, NULL, 'google', '1565615616', '2025-11-13 10:28:17', NULL),
(35, 'john1234555556@gmail.com', 'google', NULL, '2025-11-13 10:30:05', NULL),
(36, NULL, 'google', '1654161', '2025-11-13 10:30:05', NULL),
(37, 's@gmail.cxom', 'google', NULL, '2025-11-13 12:06:21', NULL),
(38, NULL, 'google', '9898989898', '2025-11-13 12:06:21', NULL),
(39, 'infinitie.prashant@gmail.com', 'google', NULL, '2025-11-13 14:13:12', NULL),
(40, NULL, 'google', '9099235751', '2025-11-13 14:13:12', NULL),
(41, 'infintie.jacksparrow@gmail.com', 'google', NULL, '2025-11-13 14:15:07', NULL),
(42, NULL, 'google', '165156651', '2025-11-13 14:15:07', NULL),
(43, 'infinitie.rahul@gmail.com', 'google', NULL, '2025-11-13 15:29:38', NULL),
(44, NULL, 'google', '4646464646', '2025-11-13 15:29:38', NULL),
(45, 'prashantkuwat7@gmail.com', 'google', NULL, '2025-11-17 10:29:09', NULL),
(46, NULL, 'google', '9595959595', '2025-11-17 10:29:09', NULL),
(47, 'tony@gmail.com', 'google', NULL, '2025-11-17 11:03:53', NULL),
(48, NULL, 'google', '1212121212', '2025-11-17 11:03:53', NULL),
(49, 'infinitie.raj@gmail.com', 'google', NULL, '2025-11-17 16:39:19', NULL),
(50, NULL, 'google', '7984102272', '2025-11-17 16:39:19', NULL),
(51, 'xidijeg3282156@delaeb.com', 'google', NULL, '2025-11-19 09:00:51', NULL),
(52, NULL, 'google', '1234567825985965', '2025-11-19 09:00:51', NULL),
(53, NULL, 'google', '9978398768', '2025-11-19 09:18:15', NULL),
(54, 'jackbfgbfg@gmail.com', 'google', NULL, '2025-11-19 10:24:21', NULL),
(55, NULL, 'google', '12345673226256', '2025-11-19 10:24:21', NULL),
(56, 'jacksdcdscs@gmail.com', 'google', NULL, '2025-11-19 10:25:18', NULL),
(57, NULL, 'google', '9876543210516', '2025-11-19 10:25:18', NULL),
(58, 'ojvfdjkmnvfjkvd@gmail.com', 'google', NULL, '2025-11-19 10:28:15', NULL),
(59, NULL, 'google', '9099235751651655', '2025-11-19 10:28:15', NULL),
(60, 'xidiccccccjeg328@delaeb.com', 'google', NULL, '2025-11-19 10:39:17', NULL),
(61, NULL, 'google', '90992357511561', '2025-11-19 10:39:17', NULL),
(62, 'jacksdcdcdccddscs@gmail.com', 'google', NULL, '2025-11-19 10:42:25', NULL),
(63, NULL, 'google', '9099235751165611', '2025-11-19 10:42:25', NULL);
...
CREATE TABLE `zipcodes` (
  ...
  `minimum_free_delivery_order_amount` double NOT NULL DEFAULT 0,
  `delivery_charges` double DEFAULT 0,
  `provider_type` enum('company','delivery_boy') NOT NULL DEFAULT 'delivery_boy',
  `date_created` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `zipcodes` (`id`, `zipcode`, `city_id`, `minimum_free_delivery_order_amount`, `delivery_charges`, `provider_type`, `date_created`) VALUES
(1, '370030', 1, 8000, 700, 'delivery_boy', '2024-09-30 06:48:59'),
(2, '370615', 1, 1000, 50, 'company', '2025-11-11 10:41:55'),
(3, '370616', 1, 165, 1556, 'company', '2025-11-13 04:59:27'),
(4, '132456', 1, 120, 50, 'company', '2025-11-20 04:36:23'),
(5, '001408', 1, 1000, 100, 'delivery_boy', '2025-11-21 05:33:16');
...
ALTER TABLE `consignments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_consignments_shipping_company_id` (`shipping_company_id`);
...
ALTER TABLE `orders`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `idx_shipping_company_orders` (`shipping_company_id`),
  ADD KEY `idx_selected_quote` (`selected_quote_id`);
...
ALTER TABLE `order_items`
  ...
  ADD KEY `order_id` (`order_id`),
  ADD KEY `product_variant_id` (`product_variant_id`),
  ADD KEY `idx_order_items_shipping_company_id` (`shipping_company_id`);
...
--
-- Indexes for table `shipping_company_quotes`
--
...
ALTER TABLE `users`
  ...
  ADD KEY `email` (`email`),
  ADD KEY `is_shipping_company` (`is_shipping_company`),
...
--
-- AUTO_INCREMENT for table `shipping_company_quotes`
--
ALTER TABLE `shipping_company_quotes`
