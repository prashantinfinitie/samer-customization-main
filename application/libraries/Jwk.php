...
class JWK
{
    ...
    public static function parseKeySet(array $jwks, string $defaultAlg = null): array
    {
        ...
        if (!isset($jwks['keys'])) {
            throw new Exception('"keys" member must exist in the JWK Set');
        }
        ...
        if (0 === \count($keys)) {
            throw new Exception('No supported algorithms found in JWK Set');
        }
    ...
    public static function parseKey(array $jwk, string $defaultAlg = null): ?Key
    {
        ...
        if (!isset($jwk['alg'])) {
            if (\is_null($defaultAlg)) {
                ...
                throw new Exception('JWK must contain an "alg" parameter');
            }
            $jwk['alg'] = $defaultAlg;
        }
        ...
        switch ($jwk['kty']) {
            ...
            case 'EC':
                ...
                if (empty($jwk['x']) || empty($jwk['y'])) {
                    throw new Exception('x and y not set');
                }
