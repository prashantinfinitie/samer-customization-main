...
class MyConfig
{
    ...
    function language()
    {
        ...
        // Map short language codes to full language folder names
        $language_map = [
            'ar' => 'arabic',
            'en' => 'english',
            'arabic' => 'arabic',
        ...
        if ($siteLang) {
            // Convert short code to full language name if needed
            $lang_to_load = isset($language_map[strtolower($siteLang)]) ? $language_map[strtolower($siteLang)] : $siteLang;
            $ci->lang->load('web_labels_lang', $lang_to_load);
        }
        else {
            // Also map default language if it's a short code
            $lang_to_load = isset($language_map[strtolower($language_name)]) ? $language_map[strtolower($language_name)] : $language_name;
            $ci->lang->load('web_labels_lang', $lang_to_load);
        }
    }
