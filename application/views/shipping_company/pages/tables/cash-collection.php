                    ...
                    <div class="card content-area p-4">
                        <div class="card-innr">
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                <div class="media d-flex">
                                                    ...
                                                    <div class="media-body text-right">
                                                        <h5 class="text-muted text-bold-500">Cash Collected by Admin</h5>
                            ...
                            <div class="row col-md-12 mt-3">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select id="filter_status" name="filter_status" class="form-control">
                                        ...
                                        <option value="shipping_company_cash">Cash Received (COD)</option>
                            ...
                            <table class='table table-striped'
                                data-toggle="table"
                                data-url="<?= base_url('shipping-company/fund-transfer/get_cash_collection') ?>"
                                ...
                                data-export-options='{"fileName": "shipping-company-cash-collection"}'
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="txn_date" data-sortable="true">Date</th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
...
<script>
function cash_collection_query_params(params) {
