                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="pro_input_text" class="col-form-label">Name (English) <span class='text-danger text-sm'>*</span></label>
                                        <input type="text" class="form-control" id="pro_input_text"
                                            placeholder="Product Name in English" name="pro_input_name"
                                            value="<?= (isset($product_details[0]['name'])) ? output_escaping(str_replace('\r\n', '&#13;&#10;', $product_details[0]['name'])) : "" ?>">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="pro_input_name_ar" class="col-form-label">Name (Arabic) <span class="badge badge-info">الاسم بالعربية</span></label>
                                        <input type="text" class="form-control" id="pro_input_name_ar"
                                            placeholder="اسم المنتج بالعربية" name="pro_input_name_ar" dir="rtl" style="text-align: right;"
                                            value="<?= (isset($product_details[0]['name_ar'])) ? output_escaping(str_replace('\r\n', '&#13;&#10;', $product_details[0]['name_ar'])) : "" ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="short_description" class="col-form-label">Short Description (English) <span class='text-danger text-sm'>*</span></label>
                                        <textarea type="text" class="form-control addr_editor" id="short_description"
                                            placeholder="Product Short Description in English"
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="short_description_ar" class="col-form-label">Short Description (Arabic) <span class="badge badge-info">الوصف المختصر</span></label>
                                        <textarea type="text" class="form-control addr_editor_rtl" id="short_description_ar"
                                            placeholder="الوصف المختصر بالعربية"
                                            name="short_description_ar"><?= isset($product_details[0]['short_description_ar']) ? output_escaping(str_replace('\r\n', '&#13;&#10;', $product_details[0]['short_description_ar'])) : ""; ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="card-body pad">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <label for="pro_input_description">Description (English)</label>
                                                <div class="mb-3">
                                                    <textarea name="pro_input_description" class="textarea addr_editor"
                                                        id="pro_input_description"
                                                        placeholder="Product description in English"><?= (isset($product_details[0]['id'])) ? output_escaping(str_replace('\r\n', '&#13;&#10;', $product_details[0]['description'])) : ''; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="pro_input_description_ar">Description (Arabic) <span class="badge badge-info">الوصف بالعربية</span></label>
                                                <div class="mb-3">
                                                    <textarea name="pro_input_description_ar" class="textarea addr_editor_rtl"
                                                        id="pro_input_description_ar"
                                                        placeholder="وصف المنتج بالعربية"><?= (isset($product_details[0]['description_ar'])) ? output_escaping(str_replace('\r\n', '&#13;&#10;', $product_details[0]['description_ar'])) : ''; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
