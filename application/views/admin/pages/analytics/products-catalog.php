<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4>Product & Catalog Analytics</h4>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    <label>&nbsp;</label>
                                    <button type="button" class="btn btn-primary btn-block" onclick="loadProductCatalog()">
...
function loadProductCatalog() {
    ...
    // Load product report
    $.ajax({
        url: '<?= base_url("admin/analytics/get_product_report") ?>',
        type: 'GET',
        data: {
            period: period,
    ...
    $.ajax({
        url: '<?= base_url("admin/analytics/get_category_report") ?>',
        type: 'GET',
        data: {
            period: period,
            start_date: startDate,
