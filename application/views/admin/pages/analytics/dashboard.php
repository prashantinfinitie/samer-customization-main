                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3">
                                    <a href="<?= base_url('admin/analytics/sales_revenue') ?>" class="btn btn-info btn-block">
                                        <i class="fas fa-chart-bar"></i> Sales & Revenue
                                    </a>
                                </div>
                                <div class="col-md-3">
                                    <a href="<?= base_url('admin/analytics/profitability') ?>" class="btn btn-success btn-block">
                                        <i class="fas fa-coins"></i> Profitability
                                    </a>
                                </div>
                                <div class="col-md-3">
                                    <a href="<?= base_url('admin/analytics/products_catalog') ?>" class="btn btn-warning btn-block">
                                        <i class="fas fa-box"></i> Products & Catalog
                                    </a>
                                </div>
                                <div class="col-md-3">
                                    <a href="<?= base_url('admin/analytics/inventory') ?>" class="btn btn-primary btn-block">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-3">
                                    <a href="<?= base_url('admin/analytics/returns') ?>" class="btn btn-danger btn-block">
                                        <i class="fas fa-undo"></i> Returns
                                    </a>
                                </div>
                                <div class="col-md-3">
                                    <a href="<?= base_url('admin/analytics/seller_comparison') ?>" class="btn btn-secondary btn-block">
                                        <i class="fas fa-users"></i> Seller Comparison
                                    </a>
                                </div>
                            </div>
                        </div>
...
function loadAnalytics() {
    ...
    // Load sales overview
    $.ajax({
        url: '<?= base_url("admin/analytics/get_sales_overview") ?>',
        type: 'GET',
        data: {
            period: period,
    ...
    // Load profit report
    $.ajax({
        url: '<?= base_url("admin/analytics/get_profit_report") ?>',
        type: 'GET',
        data: {
            period: period,
            start_date: startDate,
