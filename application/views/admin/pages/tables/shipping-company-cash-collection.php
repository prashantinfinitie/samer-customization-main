<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4>Shipping Company Cash Collection</h4>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= base_url('admin/home') ?>">Home</a></li>
                        <li class="breadcrumb-item active">Shipping Company Cash Collection</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="row ">
                                        ...
                                        <div class="form-group col-md-3">
                                            <div>
                                                ...
                                                <select id="filter_status" name="filter_status" placeholder="Select Status" class="form-control">
                                                    ...
                                                    <option value="shipping_company_cash">Shipping Company Cash Received</option>
                                                    <option value="shipping_company_cash_collection">Cash Collected by Admin</option>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group col-md-3">
                                                <div>
                                                    ...
                                                    <select id="filter_company" name="filter_company" class="form-control">
                                                        ...
                                                        <?php foreach ($shipping_companies as $row) { ?>
                        ...
                        <div class="col-md-6 ">
                            <div class="card card-info">
                                <!-- form start -->
                                <form class="form-horizontal form-submit-event" action="<?= base_url('admin/shipping_companies/manage_cash_collection'); ?>" method="POST" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <label for="name" class="col-sm-2 col-form-label">Amount to be Collected <span class='text-danger text-sm'>*</span></label>
                                            <div class="col-sm-10">
