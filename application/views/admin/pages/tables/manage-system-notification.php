                ...
                <div class="col-md-12 main-content">
                    <div class="card content-area p-4">
                        <div class="card-innr">
                            ...
                            data-url="<?= base_url('admin/Notification_settings/get_notifications_data') ?>" data-click-to-select="true" data-side-pagination="server" 
                            ...
                            data-show-export="true" data-maintain-selected="true" data-export-types='["txt","excel"]' data-query-params="noti_query_params">
                                <thead>
                                    <tr>
