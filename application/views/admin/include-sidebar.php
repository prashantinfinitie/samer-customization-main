               ...
               with font-awesome or any other icon font library -->
                ...
                <?php if (has_permissions('read', 'shipping_company') || has_permissions('read', 'fund_transfer')) { ?>
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <?php if (has_permissions('read', 'fund_transfer')) { ?>
                                <li class="nav-item">
                                    <a href="<?= base_url('admin/shipping-companies/fund_transfers/') ?>" class="nav-link">
                                        <i class="fa fa-rupee-sign nav-icon "></i>
                                        <p>Fund Transfer</p>
                                    </a>
                                </li>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item text-sm">
                            <a href="<?= base_url('admin/shipping_company_privacy_policy') ?>" class="nav-link">
                                <i class="fa fa-exclamation-triangle nav-icon  "></i>
                                <p>Shipping Company Policies</p>
                            </a>
                    </ul>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <?php if (has_permissions('read', 'analytics')) { ?>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url('admin/analytics/sales_revenue') ?>" class="nav-link">
                                    <i class="fas fa-dollar-sign nav-icon"></i>
                                    <p>Sales & Revenue</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('admin/analytics/profitability') ?>" class="nav-link">
                                    <i class="fas fa-coins nav-icon"></i>
                                    <p>Profitability</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('admin/analytics/products_catalog') ?>" class="nav-link">
                                    <i class="fas fa-box nav-icon"></i>
                                    <p>Products & Catalog</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('admin/analytics/inventory') ?>" class="nav-link">
                                    <i class="fas fa-warehouse nav-icon"></i>
                                    <p>Inventory & Purchasing</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('admin/analytics/returns') ?>" class="nav-link">
                                    <i class="fas fa-undo nav-icon"></i>
                                    <p>Returns</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('admin/analytics/seller_comparison') ?>" class="nav-link">
                                    <i class="fas fa-users nav-icon"></i>
                                    <p>Seller Comparison</p>
                                </a>
                            </li>
                        <?php } ?>
                    </ul>
