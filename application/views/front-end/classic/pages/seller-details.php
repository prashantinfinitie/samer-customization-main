...
<section class="breadcrumb-title-bar colored-breadcrumb deeplink_wrapper">
    <div class="main-content responsive-breadcrumb">
        <h2><?= isset($page_main_bread_crumb) ? $page_main_bread_crumb : 'Products' ?><?= (isset($seller_details) && !empty($seller_details[0]['username'])) ? " By " . $seller_details[0]['username'] : '' ?></h2>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <?php
                if (isset($seller_details) && !empty($seller_details[0]['username'])) { ?>
                    <li class="breadcrumb-item active text-muted" aria-current="page"><?= $seller_details[0]['username'] ?></li>
                <?php } ?>
            </ol>
        </nav>
    </div>
    ...
    <div class="product-listing card-solid py-4">
        <div class="mx-0">
            <div class="pt-3 pb-3">
                ...
                <?php if (isset($seller_stores) && !empty($seller_stores)) { ?>
                    <div class="seller_card p-5 mt-5">
                        <h3>Stores</h3>
                        <div class="row">
                            <?php foreach ($seller_stores as $store) { ?>
                                <div class="col-md-6 mb-3">
                                    <div class="border rounded p-3">
                                        <h5 class="mb-2">
                                            <i class="fa fa-store"></i> 
                                            <?= output_escaping($store['store_name']) ?>
                                            <?php if (isset($store['is_default']) && $store['is_default'] == 1) { ?>
                                                <span class="badge badge-info">Default</span>
                                            <?php } ?>
                                        </h5>
                                        <?php if (!empty($store['store_description'])) { ?>
                                            <p class="mb-0 text-muted"><?= output_escaping($store['store_description']) ?></p>
                                        <?php } ?>
                                    </div>
                                </div>
                            <?php } ?>
                ...
                <?php } elseif (isset($sellers[0]['store_description']) && !empty($sellers[0]['store_description'])) { ?>
                    <div class="seller_card p-5 mt-5">
                        <h3>About Seller</h3>
