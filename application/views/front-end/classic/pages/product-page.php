                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="card-body-right seller_tab">
                                        <h4 class="mb-0"><?= $product['product'][0]['seller_name'] . "  " ?><span class="badge badge-success "><?= number_format($product['product'][0]['seller_rating'], 1) . " " ?><i class="fa fa-star"></i></span> </h4>
                                        <span class="text-muted d-block mb-2">Seller</span>
                                        
                                        <?php if (isset($product['product'][0]['seller_stores']) && !empty($product['product'][0]['seller_stores'])) { ?>
                                            <div class="mt-2">
                                                <strong>Stores:</strong>
                                                <ul class="list-unstyled mt-2">
                                                    <?php foreach ($product['product'][0]['seller_stores'] as $store) { ?>
                                                        <li class="mb-2">
                                                            <i class="fa fa-store"></i> 
                                                            <strong><?= output_escaping($store['store_name']) ?></strong>
                                                            <?php if (isset($store['is_default']) && $store['is_default'] == 1) { ?>
                                                                <span class="badge badge-info">Default</span>
                                                            <?php } ?>
                                                            <?php if (!empty($store['store_description'])) { ?>
                                                                <br><small class="text-muted"><?= output_escaping($store['store_description']) ?></small>
                                                            <?php } ?>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                        ...
                                        <a target="_BLANK" href="<?= base_url('products?seller=' . $seller_slug[0]['slug']) ?>" class="button button-primary-outline">View All Products</a>
                                    </div>
                                </div>
                            </div>
                        </div>
