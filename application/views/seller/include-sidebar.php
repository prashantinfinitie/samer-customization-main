        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-flat" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="<?= base_url('seller/store/') ?>" class="nav-link">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('seller/analytics') ?>" class="nav-link">
                                <i class="fas fa-chart-bar nav-icon"></i>
                                <p>Analytics Dashboard</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('seller/analytics/sales_revenue') ?>" class="nav-link">
                                <i class="fas fa-dollar-sign nav-icon"></i>
                                <p>Sales & Revenue</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('seller/analytics/profitability') ?>" class="nav-link">
                                <i class="fas fa-coins nav-icon"></i>
                                <p>Profitability</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('seller/analytics/products') ?>" class="nav-link">
                                <i class="fas fa-box nav-icon"></i>
                                <p>Products</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('seller/analytics/inventory') ?>" class="nav-link">
                                <i class="fas fa-warehouse nav-icon"></i>
                                <p>Inventory & Purchasing</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('seller/analytics/returns') ?>" class="nav-link">
