...
class Products extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if (!empty($seller_slug)) {
            ...
            if (!empty($seller) && isset($seller[0]['user_id'])) {
                ...
                if (!empty($store)) {
                    // Get seller_id from store's vendor_id and fetch all products for that seller
                    $seller_id = $store['vendor_id'];
                    // Get seller data for display
                    $seller = fetch_details("seller_data", ['user_id' => $seller_id], "user_id,store_name");
                }
            }
        }
